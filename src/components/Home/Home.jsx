...
gsap.from(".title2",{
  ...
  <Navbar/>
    <div className=' md:flex sm:flex-col  ' id='home'>
      <img src={pic} alt=" my pic" loading='lazy' className= 'pic absolute w-[150px] h-[150px] left-[50%] translate-x-[-50%] translate-y-[20px] sm:left-[50%] sm:top-[20%]   sm:translate-x-[-50%] sm:w-[150px] sm:h-[150px]  lg:w-[200px]  lg:h-[200px] lg:absolute lg:left-[75%] lg:top-[30%] object-cover border-4 border-double rounded-full z-50'/>
      ...
      <div/>
      <div className='social absolute top-[85%] left-[20%]  xl:top-[80%] xl:left-[40%] sm:top-[80%] sm:left-[50%] lg:top-[70%] lg:left-[18%] flex  mt-3 ms-2 m-2 '>
...
<div className='titles m-4 absolute sm:top-[50%] lg:top-[30%]  top-[45%]'>
...
{/* <p className='text-xl md:text-3xl my-2 ms-24 font-semibold '>Backend node.js</p> */}
 ...
 <button  className= 'button top-[70%] left-[25%]  hover:scale-x-[1.2] hover:bg-[#08BDBA] xl:w-[300px] absolute md:left-[70px] sm:top-[76%] sm:left-[10%] lg:top-[55%] lg:left-[20%] ms-4 mt-5 border-2 border-[#08BDBA] rounded-full p-2'> <a ref={hire} target='-blank' className='text-[#0e6968] font-medium text-2xl hire hover:text-white' href="https://drive.google.com/file/d/1Ga751jU_DSEVMO4UmPJIwDkIIHkJSuBW/view?usp=sharing">Hire Me </a></button>
