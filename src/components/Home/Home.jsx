...
gsap.from(".title2",{
  ...
  <Navbar/>
    <div className=' md:flex sm:flex-col  ' id='home'>
      <img src={pic} alt=" my pic"  className= 'pic absolute  sm:left-[50%] sm:top-[20%]   sm:translate-x-[-50%] sm:w-[150px] sm:h-[150px]  lg:w-[200px]  lg:h-[200px] lg:absolute lg:left-[75%] lg:top-[30%] object-cover border-4 border-double rounded-full z-50'/>
      <img  src={blob} alt=" blob pic" width="100%" height="100%" className='blob absolute  xl:top-[-65%] xl:left-[60%] xl:w-[60%] md:left-[40%] sm:left-[60%] sm:top-[-30%] lg:left-[40%] lg:bottom-[-40%]  '/>
      <div/>
      <div className='social absolute xl:top-[80%] xl:left-[40%] sm:top-[80%] sm:left-[50%] lg:top-[70%] lg:left-[18%] flex  mt-3 ms-2 m-2 '>
...
<div className=' m-4 absolute sm:top-[50%] lg:top-[30%] '>
...
{/* <p className='text-xl md:text-3xl my-2 ms-24 font-semibold '>Backend node.js</p> */}
 ...
 <button  className= 'button   hover:scale-x-[1.2] hover:bg-[#08BDBA] xl:w-[300px] absolute xl:top-[80%] sm:top-[79%] sm:left-[10%] lg:top-[55%] lg:left-[20%] ms-4 mt-5 border-2 border-[#08BDBA] rounded-full p-2'> <a ref={hire} target='-blank' className='text-[#0e6968] font-medium text-2xl hire hover:text-white' href="https://drive.google.com/file/d/1Ga751jU_DSEVMO4UmPJIwDkIIHkJSuBW/view?usp=sharing">Hire Me </a></button>
